<?php
  ...
  class Post extends Table
  {
    ...
    public function getOneById($id) {
        return $this->query("SELECT articles.id, articles.date, articles.content, articles.title, categories.title as categorie FROM articles LEFT JOIN categories ON category_id = categories.id WHERE articles.id = ?", [$id], true);
    }
  }
